...
for (let i = 1; i <241; i++) { // boucle for qui exécute le code entre accolades 241 fois
...
document.onkeydown = function(event) { // événement de touche enfoncée
    ...
    switch (event.keyCode) { // vérifie le code de la touche enfoncée
        ...
        if (indexTireur >= 180) { // vérifie que le tireur ne se trouve pas à plus de trois de distance 
